        ...
        <header class="site-header outer">
            ...
            <div class="inner">
                ...
                <section class="error-message">
                    ...
                    <p class="error-description"><?php _e( 'It seems the page you are looking for has gone astray.', 'casper' ); ?></p>
                   
            <a class="error-link" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">Go to the front page →</a>
                </section>
