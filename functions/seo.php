...
/*
  Usage: 
    ...
    2. add <?php echo casper_seo(); ?> to the header - already added to templates/head-meta.php
...
function casper_seo() {
  ...
  $default_keywords = 'wordpress, themes, design, development, php, html, css, jquery, scss, casper'; // customize
  $output = '';
